...
from generator.models.mlp import mnet_model

from generator.losses.losses import build_loss
from generator.optimizers import build_optimizer
from generator.data_preparation.mnet_dataloader import LoadData, build_dataloader
...
from generator.train.motion_module import motion_module
...
def train():
    ...
    parser.add_argument('--source-grab-path',
    ...
    parser.add_argument('--expr-id', default='MNet_V00', type=str,
                        help='Training ID')
