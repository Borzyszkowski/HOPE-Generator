...
import random
import cv2
from datasets.oakink.oikit.oi_image import OakInkImage
from datasets.oakink.oikit.oi_image.viz_tool import draw_wireframe, draw_wireframe_hand, caption_view
